...
const List<Quote> ALL_QUOTES = [
  ...
  Quote('abe_fellow_chump', 'Hey there, fellow chump!', SRC_ABE, 'Hey there fellow chump v3'),
  Quote('abe_help_munch', 'Help, Munch!', SRC_ABE, 'help munch i\'m taking a beating down here v3'),
  Quote('abe_it_was_us', 'It was us!', SRC_ABE, 'it was us'),
  Quote('abe_its_a_bone', 'It\'s a bone', SRC_ABE, 'it\'s its a bone'),
  Quote('harry_potter_earwax', 'Alas, earwax', SRC_HARRY_POTTER, 'alas earwax v3', 'dumbledore'),
  Quote('harry_potter_guttersnipes', 'Rotten little guttersnipes', SRC_HARRY_POTTER,
      'you rotten little guttersnipes guttersnoipes'),
  Quote('tr_a_backpack', 'Ah, a backpack', SRC_TOMB_RAIDER, 'ah a backpack', 'tomb_raider_4'),
  Quote('tr_dive_through_the_gap', 'Dive through the gap', SRC_TOMB_RAIDER,
      'dive through the gap press action to perform a diving roll', 'tomb_raider_4'),
  Quote('tr_gut_rot', 'Gut rot', SRC_TOMB_RAIDER, 'have faith fabio not gut rot'),
  Quote('tr_lifes_work_well', 'My life\'s work well', SRC_TOMB_RAIDER,
      'you not know my life\'s work well? you sure you\'re youre not here for them?'),
  ...
  Quote('tr_move_to_strike', 'Move to strike', SRC_TOMB_RAIDER, 'how is this i move to strike and yet cannot verdilect',
      'tomb_raider_5'),
  Quote('tr_tony_guy_on_my_keyring', 'Tony guy on my keyring', SRC_TOMB_RAIDER,
      'there\'s theres a tony guy on my keyring'),
  ...
  Quote('tv_burp_only_picking_on_me', 'Picking on me', SRC_TV_BURP,
      'youre only picking on me because im smaller than you'),
  ...
  Quote('cye_youve_gotta_go_there', 'Gotta go there', SRC_CYE,
      'you\'ve youve gotta go there have a donut doughnut have a bagel'),
  ...
  Quote('hyacinth_blind', 'Thought I\'d gone blind', SRC_HYACINTH, 'thank god for that I thought I\'d gone blind v3', 'onslo'),
  ...
  Quote('inside_no_9_coathangers', 'Coathangers', SRC_INSIDE_NUMBER_9, 'perhaps you need some coathangers v3'),
  ...
  Quote('toast_unleashed_armageddon', 'Armageddon', SRC_TOAST,
      'i\'ve just given the order to fire the nuclear weapons ive just unleashed armageddon'),
  ...
  Quote('riverbank_wind_it_up', 'Wind it up', SRC_RIVERBANK,
      'what you\'ve youve got to do is get it down and wind it up uup'),
  ...
  Quote(
      'sooty_on_your_head_be_it', 'On your head be it', SRC_SOOTY, 'on your own head be it or at least I hope it will'),
  ...
  Quote('tots_hiccups', 'Hiccups', SRC_TOTS_TV,
      'i\'ll ill tell you what the problem is i\'ve ive got the hiccups hiccoughs'),
  ...
  Quote(
      'christmas_carol_underdone_turnip', 'Underdone turnip', SRC_CHRISTMAS_CAROL, 'mouldy cheese an underdone turnip'),
