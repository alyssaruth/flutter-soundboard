...
const QuoteSource SRC_RIVERBANK = QuoteSource("Tales of the Riverbank", QuoteCategory.KIDS_TV, "tales_of_the_riverbank");
...
const QuoteSource SRC_WALLACE_AND_GROMIT = QuoteSource("Wallace and Gromit", QuoteCategory.KIDS_TV, "wallace_and_gromit");
const QuoteSource SRC_BODGER_AND_BADGER = QuoteSource("Bodger and Badger", QuoteCategory.KIDS_TV, "bodger_and_badger");
const QuoteSource SRC_FORGOTTEN_TOYS = QuoteSource("The Forgotten Toys", QuoteCategory.KIDS_TV, "the_forgotten_toys", "bear");
